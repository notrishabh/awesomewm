...
globalkeys = gears.table.join(
    ...
    awful.key({ "Control", "Shift" },            "n",     function () awful.util.spawn("bash -c 'pactl set-card-profile bluez_card.18_95_52_6E_0F_A6 headset-head-unit'") end,
              {description = "mic usage (HSP)", group = "bt earphone"}),
